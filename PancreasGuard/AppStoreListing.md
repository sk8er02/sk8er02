...
SMART MONITORING
Your Apple Watch continuously tracks heart rate, heart rate variability (HRV), blood oxygen, temperature, and activity. PancreasGuard watches for the warning signs research has linked to pancreatitis flares — like sustained elevated heart rate and dropping HRV — and alerts you when multiple signals align.
...
Now with AI food scanning — photograph your meal and instantly identify pancreatitis triggers. All processed on-device with Apple Intelligence.

## What's New (for updates)
• AI Food Scanner: Take a photo of any meal or drink — on-device AI identifies it, estimates fat content, detects alcohol, and auto-fills your food log
• Full Apple Health integration: reads AND writes dietary and symptom data
• New dietary fat risk signal in the scoring engine
